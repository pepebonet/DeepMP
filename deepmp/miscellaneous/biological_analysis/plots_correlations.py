...
def do_boxplot_comparisons(df, label, plot_type, output):
    ...
    for me in ['DeepMP', 'DeepSignal', 'Nanopolish', 'Guppy']:
        custom_lines.append(
            ...
            mew=0, color=palette_dict[me], label=me)[0] 
        )
    ...
    b.set_xlabel("Method Methylation Frequency", fontsize=12)
    b.set_ylabel("Bisulfite Methylation Frequency", fontsize=12)
...
def main(imprinting_results, line1_results, imprinting_freq, line1_freq, output):
    ...
    do_boxplot_comparisons(imp_freq, reg_imp, imp, 'Imprinting Genes', 'boxplot', output)
    do_boxplot_comparisons(line1_freq, reg_line1, line1, 'LINE1', 'boxplot', output)
