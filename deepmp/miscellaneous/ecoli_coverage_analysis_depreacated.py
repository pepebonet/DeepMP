...
def do_cov_analysis(df, cov_1x, label_1x, cov_2x, label_2x, cov_5x, label_5x, cov_10x, label_10x,
    ...
    #     label = 1
    # else:
    #     label = df.methyl_label.unique()[0]

    x1 = df.sample(n=1)
    cov_1x = do_beta_analysis(x1, cov_1x)
    pred_005_1x, pred_01_1x, pred_02_1x, pred_03_1x, pred_04_1x, pred_05_1x, label_1x = \
        pred_site_all(x1, pred_005_1x, pred_01_1x, pred_02_1x, 
            pred_03_1x, pred_04_1x, pred_05_1x, label_1x)
    # label_1x.append(label) 

    if df_shape >= 2:
        x2 = df.sample(n=2)
        cov_2x = do_beta_analysis(x2, cov_2x)
        pred_005_2x, pred_01_2x, pred_02_2x, pred_03_2x, pred_04_2x, pred_05_2x, label_2x = \
            pred_site_all(x2, pred_005_2x, pred_01_2x, pred_02_2x, 
                pred_03_2x, pred_04_2x, pred_05_2x, label_2x)
        # label_2x.append(label) 
    
    if df_shape >= 5: 
        x5 = df.sample(n=5)
        cov_5x = do_beta_analysis(x5, cov_5x)
        pred_005_5x, pred_01_5x, pred_02_5x, pred_03_5x, pred_04_5x, pred_05_5x, label_5x = \
            pred_site_all(x5, pred_005_5x, pred_01_5x, pred_02_5x, 
                pred_03_5x, pred_04_5x, pred_05_5x, label_5x)
        # label_5x.append(label) 

    if df_shape >= 60:
        x10 = df.sample(n=60)
        cov_10x = do_beta_analysis(x10, cov_10x)
        pred_005_10x, pred_01_10x, pred_02_10x, pred_03_10x, pred_04_10x, pred_05_10x, label_10x = \
            pred_site_all(x10, pred_005_10x, pred_01_10x, pred_02_10x, 
                pred_03_10x, pred_04_10x, pred_05_10x, label_10x)
